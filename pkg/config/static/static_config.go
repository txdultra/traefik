...
import (
	...
	"github.com/txdultra/traefik/v2/pkg/ping"
	acmeprovider "github.com/txdultra/traefik/v2/pkg/provider/acme"
	"github.com/txdultra/traefik/v2/pkg/provider/consulcatalog"
	"github.com/txdultra/traefik/v2/pkg/provider/docker"
	"github.com/txdultra/traefik/v2/pkg/provider/ecs"
	"github.com/txdultra/traefik/v2/pkg/provider/file"
	"github.com/txdultra/traefik/v2/pkg/provider/http"
	"github.com/txdultra/traefik/v2/pkg/provider/kubernetes/crd"
	"github.com/txdultra/traefik/v2/pkg/provider/kubernetes/gateway"
	"github.com/txdultra/traefik/v2/pkg/provider/kubernetes/ingress"
	"github.com/txdultra/traefik/v2/pkg/provider/kv/consul"
	"github.com/txdultra/traefik/v2/pkg/provider/kv/etcd"
	"github.com/txdultra/traefik/v2/pkg/provider/kv/redis"
	"github.com/txdultra/traefik/v2/pkg/provider/kv/zk"
	"github.com/txdultra/traefik/v2/pkg/provider/marathon"
	"github.com/txdultra/traefik/v2/pkg/provider/nomad"
	"github.com/txdultra/traefik/v2/pkg/provider/rancher"
	"github.com/txdultra/traefik/v2/pkg/provider/rest"
	"github.com/txdultra/traefik/v2/pkg/tls"
	"github.com/txdultra/traefik/v2/pkg/tracing/datadog"
	"github.com/txdultra/traefik/v2/pkg/tracing/elastic"
	"github.com/txdultra/traefik/v2/pkg/tracing/haystack"
	"github.com/txdultra/traefik/v2/pkg/tracing/instana"
	"github.com/txdultra/traefik/v2/pkg/tracing/jaeger"
	"github.com/txdultra/traefik/v2/pkg/tracing/zipkin"
