...
import (
	...
	"github.com/txdultra/traefik/v2/pkg/server/router"
	tcprouter "github.com/txdultra/traefik/v2/pkg/server/router/tcp"
	udprouter "github.com/txdultra/traefik/v2/pkg/server/router/udp"
	"github.com/txdultra/traefik/v2/pkg/server/service"
	"github.com/txdultra/traefik/v2/pkg/server/service/tcp"
	"github.com/txdultra/traefik/v2/pkg/server/service/udp"
	"github.com/txdultra/traefik/v2/pkg/tls"
	udptypes "github.com/txdultra/traefik/v2/pkg/udp"
)
